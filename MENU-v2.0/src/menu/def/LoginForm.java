...
public class LoginForm extends javax.swing.JFrame {
    public LoginForm() {
        initComponents();
        this.setLocationRelativeTo(null);// la ventana abre en el medio
    }
    ...
    private void initComponents() {
        ...
        jusernamefield.setBackground(new java.awt.Color(255, 102, 102));
        jusernamefield.setFont(new java.awt.Font("Montserrat", 0, 14)); // NOI18N
        jusernamefield.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jusernamefieldActionPerformed(evt);
            }
        });
        jPanel2.add(jusernamefield, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 220, 30));
        ...
        jPanel2.add(jpasswordfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 220, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (password.contains("juanito") && (username.contains("1234"))) {
            jusernamefield.setText(null);
            jpasswordfield.setText(null);
            
        MENULed menuled = new MENULed();
        menuled.setVisible(true); 
        menuled.pack();
        menuled.setLocationRelativeTo(null);
        menuled.setDefaultCloseOperation(LoginForm.EXIT_ON_CLOSE);
        this.dispose(); 
         }
